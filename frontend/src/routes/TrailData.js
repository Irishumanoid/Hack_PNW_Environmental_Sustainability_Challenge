...
export default function TrailData(props) {
    ...
    {
        let response = await fetch(`http://chrissytopher.com:5000/get_relavant_segments?bounding_width=${bounding_width}&bounding_center_lat=${bounding_center_lat}&bounding_center_long=${bounding_center_long}`, {mode: 'no-cors'});
        console.log(response);
    }

    

    getData(1000, 47.6062, 122.3321);
